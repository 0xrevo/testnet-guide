...
Manual guides:
- [Run Validator and Bridge Node on same machine](https://github.com/0xrevo/testnet-guide/blob/main/celestia/manual_install.md)
- [Run Bridge Node seperately](https://github.com/0xrevo/testnet-guide/blob/main/celestia/manual_bridge.md)
- [Run Light Node seperately](https://github.com/0xrevo/testnet-guide/blob/main/celestia/manual_light.md)
- [Run Full Node seperately](https://github.com/0xrevo/testnet-guide/blob/main/celestia/manual_full.md)
...
```
wget -O celestia.sh https://raw.githubusercontent.com/0xrevo/testnet-guide/main/celestia/celestia.sh && chmod +x celestia.sh && ./celestia.sh
```

### Option 2 (manual)
You can follow [manual guide](https://github.com/0xrevo/testnet-guide/blob/main/celestia/manual_install.md) if you better prefer setting up node manually
...
```
wget -O synctime.py https://raw.githubusercontent.com/0xrevo/testnet/main/celestia/tools/synctime.py && python3 ./synctime.py
```
